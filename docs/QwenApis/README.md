...
> 当前 Catalog 决策：Wan 2.0、2.1、2.2、2.5、2.6 文生图不再提供给新任务。`Wan V2.md` 与下面的旧 Profile 说明继续作为供应商资料和历史任务兼容依据，不代表产品中可选的模型 API。
...
当前快照足以作为以下能力的设计与兼容参考：

- Z-Image 文生图；
- Wan 2.6 与旧版 Wan 文生图（仅资料与历史执行兼容，不进入当前 Catalog）；
