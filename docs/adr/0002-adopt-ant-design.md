...
Adopt Ant Design 6 as the default component and design system, including standard components, icons, typography, semantic colors, spacing, feedback, accessibility behavior, and interaction patterns.
...
- Standard controls use Ant Design. `@ant-design/icons` replaces the previous icon library.
