...
```curl
curl --location --request POST 'https://www.runninghub.cn/openapi/v2/pixverse-v6/image-to-video' \
...
| --- | --- | --- | --- |
| `imageUrl` | String | 必填 | 参考图片<br>最多支持 1 项图片，每张 10 MB |
| `prompt` | String | 必填 | 运动、镜头和场景氛围的文本描述 |
