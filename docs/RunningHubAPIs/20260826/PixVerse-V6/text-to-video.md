...
```curl
curl --location --request POST 'https://www.runninghub.cn/openapi/v2/pixverse-v6/text-to-video' \
...
| --- | --- | --- | --- |
| `prompt` | String | 必填 | 场景、运动、镜头和氛围的文本描述 |
| `resolution` | String | 必填 | 输出分辨率<br>枚举值: [360p, 540p, 720p, 1080p] |
| `duration` | Int | 必填 | 视频时长（秒）<br>输入范围值: 1 - 15 |
| `generateAudioSwitch` | Boolean | 必填 | 是否生成同步音频 |
| `aspectRatio` | String | 可选 | 输出画幅比例<br>枚举值: [16:9, 4:3, 1:1, 3:4, 9:16, 2:3, 3:2, 21:9] |
