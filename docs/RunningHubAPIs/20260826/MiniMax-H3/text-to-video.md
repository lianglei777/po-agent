...
```curl
curl --location --request POST 'https://www.runninghub.cn/openapi/v2/minimax/hailuo-h3/text-to-video' \
...
| `ratio` | String | 可选 | 宽高比，默认 adaptive。<br>枚举值: [21:9, 16:9, 4:3, 1:1, 3:4, 9:16] |
