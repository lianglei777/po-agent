...
```curl
curl --location --request POST 'https://www.runninghub.cn/openapi/v2/minimax/hailuo-h3/image-to-video' \
...
| `firstFrameUrl` | String | 可选 | 首帧图（可选，与尾帧至少填一个）<br>最多支持 1 项图片，每张 30 MB |
| `lastFrameUrl` | String | 可选 | 尾帧图（可选，与首帧至少填一个）<br>最多支持 1 项图片，每张 30 MB |
