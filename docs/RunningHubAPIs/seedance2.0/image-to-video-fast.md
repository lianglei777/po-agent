...
```curl
curl --location --request POST 'https://www.runninghub.cn/openapi/v2/rhart-video/sparkvideo-2.0-fast/image-to-video' \
...
### 接口描述
```
name ：seedance2.0-Fast/图生视频
desc：seedance 2.0 Fast 图生视频，更注重生成速度与性价比。支持首帧图生视频和首尾帧图生视频两种模式，快速将静态图片转化为 4-15 秒的动态影像。
tags：更快生成速度
高性价比|首帧/首尾帧模式|有声视频生成|多种宽高比
```
