...
```curl
curl --location --request POST 'https://www.runninghub.cn/openapi/v2/rhart-audio/extract-background' \
--header "Content-Type: application/json" \
--header "Authorization: Bearer ${RUNNINGHUB_API_KEY}" \
--data-raw '{
  "videoUrl": "https://www.runninghub.cn/view?filename=2c429fb963a46a9aae25513eaf68f0a592f3ac2f0dd7dbbe2d67a497371199c5.mp4&type=input&subfolder=&Rh-Comfy-Auth=eyJ1c2VySWQiOiJiZDg3MzBjZTRiYjYxNTAzYjAyZjk1NTk5YzMwZTY3ZiIsInNpZ25FeHBpcmUiOjE3ODg4NDI2NjM4MTAsInRzIjoxNzg4MjM3ODYzODEwLCJzaWduIjoiNDMzMTllZGZkZTk3Zjc4ZTNkNTkwN2Y4MzUyNWUxNmQifQ==&Rh-Identify=bd8730ce4bb61503b02f95599c30e67f&rand=0.38837799623983915"
}'
```

#### 接口描述
```
name: extract-background audio
desc: 通过 AI 音频分离技术，提取视频中的场景音、环境音或伴奏（Background / Instrumental），彻底消除人声。
tags:  分离音频-background
```
...
| --- | --- | --- | --- |
| `videoUrl` | String | 必填 | 上传视频<br>最多支持 1 项视频，每个 200 MB |
