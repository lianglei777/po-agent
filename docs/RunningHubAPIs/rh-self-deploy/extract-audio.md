...
```curl
curl --location --request POST 'https://www.runninghub.cn/openapi/v2/rhart-audio/source-separation' \
--header "Content-Type: application/json" \
--header "Authorization: Bearer ${RUNNINGHUB_API_KEY}" \
--data-raw '{
  "videoUrl": "https://www.runninghub.cn/view?filename=c759e14ff2666ba059bd202d9689e10fa23ec956368551af6314cea89d4bc345.mov&type=input&subfolder=&Rh-Comfy-Auth=eyJ1c2VySWQiOiIzZjY1MTNlNWEwNjY1N2I4OGYyNjU5NTEzYmU3ZDM0YyIsInNpZ25FeHBpcmUiOjE3Nzc4NzA1MzI1NDcsInRzIjoxNzc3MjY1NzMyNTQ3LCJzaWduIjoiZWZkYzhmNzc4Y2ZjYWI3M2NlMWVjZGE1NzYwZDAyNzAifQ==&Rh-Identify=3f6513e5a06657b88f2659513be7d34c&rand=0.8250575352635066"
}'
```
...
| --- | --- | --- | --- |
| `videoUrl` | String | 必填 | 最多支持 1 项视频，每个 100 MB |
