...
```curl
curl --location --request POST 'https://www.runninghub.cn/openapi/v2/rhart-audio/extract-vocal' \
--header "Content-Type: application/json" \
--header "Authorization: Bearer ${RUNNINGHUB_API_KEY}" \
--data-raw '{
  "videoUrl": "https://www.runninghub.cn/view?filename=2c429fb963a46a9aae25513eaf68f0a592f3ac2f0dd7dbbe2d67a497371199c5.mp4&type=input&subfolder=&Rh-Comfy-Auth=eyJ1c2VySWQiOiJiZDg3MzBjZTRiYjYxNTAzYjAyZjk1NTk5YzMwZTY3ZiIsInNpZ25FeHBpcmUiOjE3ODg4NDI1OTkzMTIsInRzIjoxNzg4MjM3Nzk5MzEyLCJzaWduIjoiYWE3YTk4YjM5MzE2ZGZlYWZmZjZiNGNiNGU5NjQ2ZDgifQ==&Rh-Identify=bd8730ce4bb61503b02f95599c30e67f&rand=0.7876621376261783"
}'
```

#### 接口描述
```
name: extract person audio
desc: 通过 AI 音频分离技术，提取视频或音频文件中的纯人声（Vocal），并过滤掉背景音效与伴奏。
tag: 分离音频-Vocals
```
#### 请求参数说明
