...
```curl
curl --location --request POST 'https://www.runninghub.cn/openapi/v2/rhart-video/minimax-h3-oss/fl2va-advanced' \
...
#### 接口描述
```
name: MiniMax H3 ref2va RH插件流 支持多参

desc: 专为复杂多模态参考与精细控制打造的高级视频生成接口。默认支持 768P 高清输出，支持最多 9 张参考图、3 个参考视频与 3 个参考音频联合输入，提供精细像素与多参数自由调优，满足专业级多模态融合与高一致性生成需求。
tags: 多图音视参考| 默认768P输出| 精细像素调节| 专业多参定制|
```
...
| --- | --- | --- | --- |
| `image1` | String | 可选 | 最多支持 1 项图片，每张 100 MB |
| `image2` | String | 可选 | 最多支持 1 项图片，每张 100 MB |
| `image3` | String | 可选 | 最多支持 1 项图片，每张 100 MB |
| `image4` | String | 可选 | 最多支持 1 项图片，每张 100 MB |
| `image5` | String | 可选 | 最多支持 1 项图片，每张 100 MB |
| `image6` | String | 可选 | 最多支持 1 项图片，每张 100 MB |
| `image7` | String | 可选 | 最多支持 1 项图片，每张 100 MB |
| `image8` | String | 可选 | 最多支持 1 项图片，每张 100 MB |
| `image9` | String | 可选 | 最多支持 1 项图片，每张 100 MB |
| `video1` | String | 可选 | 最多支持 1 项视频，每个 100 MB |
| `video2` | String | 可选 | 最多支持 1 项视频，每个 100 MB |
| `video3` | String | 可选 | 最多支持 1 项视频，每个 100 MB |
| `audio1` | String | 可选 | 最多支持 1 项音频，每个 100 MB |
| `audio2` | String | 可选 | 最多支持 1 项音频，每个 100 MB |
| `audio3` | String | 可选 | 最多支持 1 项音频，每个 100 MB |
| `prompt` | String | 可选 | 文本长度限制: 0 - 20000 |
| `aspectRatio` | String | 可选 | 枚举值: [1:1 (Square), 2:3 (Portrait Photo), 3:2 (Photo), 3:4 (Portrait Standard), 4:3 (Standard), 9:16 (Portrait Widescreen), 16:9 (Widescreen), 21:9 (Ultrawide)] |
| `duration` | Float | 必填 | 输入范围值: 5 - 15 |
