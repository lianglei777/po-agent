...
export const zh = {
  ...
  contentGeneration: {
    ...
    runningHubCredentialDescription: "API Key 保存在本地，保存后接口不会返回其明文。",
    ...
    availableRoutesDescription: "这些只读路由由应用维护，用于定义支持的能力和输入。",
    routeEnabled: "已启用",
    routeDisabled: "已停用",
    providers: "内容生成供应商",
    addProvider: "添加供应商",
    ...
    apiDocumentationDescription: "以下内容来自项目内置的供应商文档，用于说明请求参数、响应结构和调用方式。",
    ...
    templateInputs: "生成输入",
    templateInputsDescription: "这些输入会在生成对话中显示，用户无需编辑请求 JSON。",
