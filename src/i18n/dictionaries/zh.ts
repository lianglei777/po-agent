...
export const zh = {
  ...
  contentGeneration: {
    ...
    title: "内容生成",
    description: "配置第三方图片和视频生成服务的上传、提交、查询与结果映射。",
    apis: "已配置 API",
    addApi: "添加 API",
    ...
    newSessionTitle: "创建新会话",
    newSessionDescription: "为本次会话选择一种模式。创建后不能切换模式。",
    chatMode: "模型对话",
    chatModeDescription: "使用已配置的语言模型和 Agent 工具。",
    mode: "内容生成",
    modeDescription: "使用一个已配置的 API 生成图片或视频。",
    noConfiguredApis: "尚未配置内容生成 API",
    createSession: "创建生成会话",
    creatingSession: "创建中...",
