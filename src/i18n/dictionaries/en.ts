export const en = {
  ...
  workspace: {
    ...
    conversationNavigator: "Conversation navigation",
    jumpToConversation: "Jump to conversation: {title}",
    ...
    sessionGenerationView: "Generate",
    models: "Models",
    skills: "Skills",
    settings: "Settings",
  ...
  contentGeneration: {
    ...
    routeEnabledCount: "{enabled} / {total} enabled",
    defaultRoute: "Default",
    makeDefaultRoute: "Make default",
    capabilityTextToImage: "Text to image",
    capabilityImageToImage: "Image to image",
    capabilityTextToVideo: "Text to video",
    capabilityImageToVideo: "Image to video",
    capabilityMultimodalToVideo: "Multimodal to video",
    capabilityVideoToAudio: "Video to audio",
    showRouteDescription: "View model details",
    hideRouteDescription: "Hide model details",
    routeInfo: "Model details",
    routeSettings: "API settings",
    routeEnabledDescription:
      "Controls whether this API can be used by the canvas, generation page, and Agent.",
    enableRouteFirst: "Enable this API first.",
    defaultForCapability: "Default {capability} API",
    defaultForCapabilityDescription:
      "Prefer this API when automatically selecting a {capability} API.",
    makeDefaultForCapability: "Make default for {capability}",
    goToProviderSettings: "Open provider settings",
    routeDetails: "API information",
    modelProduct: "Model family",
    ...
    navigatorDescription: "Select a provider or model API",
    resizeNavigator: "Resize content generation navigation",
    expandResource: "Expand {resource}",
    collapseResource: "Collapse {resource}",
    unsavedCredential: "Credential has unsaved changes",
    providerEnabledStatus: "Provider enabled",
    providerDisabledStatus: "Provider disabled",
    ...
    defaultInputs: "Default generation inputs",
    ...
    apiKeyFromEnvironment: "Using the key from the environment. Save a new key to override it.",
    credentialSource: "Current source",
    credentialSourceStoredFile: "Application credential file",
    credentialSourceEnvironment: "Environment variable",
    credentialSourceMissing: "Not configured",
    credentialLocation: "Credential location",
    copyLocation: "Copy location",
    copyCredentialLocation: "Copy API key credential location",
    credentialLocationCopied: "Credential location copied",
    credentialLocationCopyFailed: "Could not copy credential location",
    ...
    bodyTemplate: "Request body template (JSON)",
    taskIdPath: "Task ID path",
    statusPath: "Status path",
    errorPath: "Error path",
    asyncGeneration: "The provider returns an asynchronous task",
    pendingValues: "Pending values",
    successValues: "Success values",
    failureValues: "Failure values",
    pollInterval: "Polling interval (ms)",
    enableUpload: "Upload local images through the provider",
    fileField: "Multipart file field",
    uploadUrlPath: "Uploaded URL path",
    uploadErrorPath: "Upload error path",
    collectionPath: "Output collection path",
    outputUrlPath: "Output URL path",
    outputTypePath: "Output type path",
    outputTextPath: "Output text path",
    deleteConfirm:
    ...
    insertReference: "Insert asset reference",
    noPrompt: "(No prompt)",
    addImage: "Add image",
    ...
    copied: "Copied",
    submitRequest: "View submit request body",
    submitResponse: "View submit response",
    ...
    inputs: {
      ...
      promptExtend: "Prompt enhancement",
      fileUrl: "Document URL",
      linkUrl: "Web page URL",
      firstFrameUrl: "First frame",
      lastFrameUrl: "Last frame",
      imageUrls: "Reference images",
      videoUrls: "Reference videos",
      audioUrls: "Reference audio",
  ...
  chat: {
    ...
    input: {
      ...
      generationControl: "Content generation",
      generationAutomatic: "Automatic",
      generationReview: "Review first",
      chatMode: "Chat",
      generationAutoRoute: "Automatically select generation API",
      generationExecution: "Execution",
      generationDirect: "Run directly",
      generationImage: "Images",
      generationVideo: "Videos",
      generationAudio: "Audio",
      generationOptionsFailed: "Unable to load content generation APIs.",
      generationSlotAmbiguous: "The selected API has multiple compatible asset slots. Choose a specific API and add files to the named slots.",
      generationRequiredAssets: "Required assets are missing: {slots}",
      generationSubmitFailed: "Content generation could not be started.",
      ...
      generationPlanFailed: "Unable to determine how to handle this request.",
      generationToggle: "Enable content generation",
      generationCapabilityDescription: "Use an enabled generation API only when the request has a clear generation intent.",
      generationApi: "Specific generation API",
      generationAutoDescription: "Choose an API from the request and attached media.",
      generationReviewDescription: "Review the resolved prompt and parameters before provider work starts. When off, generation runs directly.",
      generationNoApis: "No content generation APIs are available. Enable a provider and credential in Settings.",
      generationEnabledSummary: "Content generation enabled · {api} · {execution}",
      generationDisabledSummary: "Content generation is off",
      generationUnavailableWhileBusy: "Content generation settings cannot change while the current task is running.",
      generationHelp: "About {item}",
    ...
    message: {
     ...
     editFromHere: "Edit from here",
      ...
      generationRunId: "Local Run ID",
      providerTaskId: "Provider Task ID",
      runningHubTaskId: "RunningHub Task ID",
      generationArtifact: "Generated artifact",
      generationEffectivePrompt: "Actual prompt sent to the generation API",
      generationToolInput: "Generation tool input from the model",
  ...
  skills: {
    ...
    scopeGlobalDescription:
      "Available in every project, including projects added later.",
  ...
  pipeline: {
    canvasAgentPanelTitle: "Canvas Agent",
    canvasAgentPanelCollapse: "Collapse Agent panel",
    canvasAgentPanelExpand: "Expand Agent panel",
    canvasAgentPanelModel: "Agent model",
    canvasAgentPanelVision: "Vision",
    canvasAgentPanelWorkflowFailedCount: "{count} failed",
    canvasAgentPanelWorkflowBlockedCount: "{count} blocked",
    canvasAgentPanelNoModel: "No configured model",
    canvasAgentPanelAllowGeneration: "Allow automatic generation",
    canvasAgentPanelAllowGenerationDescription: "When enabled, the Agent may start image, video, or audio generation only when your current request explicitly asks for generated content.",
    canvasAgentPanelPlaceholder: "Describe what you want to create or adjust…",
    canvasAgentPanelSend: "Send",
    canvasAgentPanelStop: "Stop",
    canvasAgentPanelEmpty: "Tell the Agent what you want to accomplish. It will keep this project's conversation separate from every other project.",
    canvasAgentPanelRunning: "Agent is working",
    canvasAgentPanelLoadError: "Unable to load the Canvas Agent.",
    canvasAgentPanelConversationLoadError: "Unable to restore the Agent conversation.",
    canvasAgentPanelModelsLoadError: "Unable to load Agent models.",
    canvasAgentPanelWorkflowRunsLoadError: "Unable to load canvas workflows.",
    canvasAgentPanelHistoryLoadError: "Unable to load Agent history.",
    canvasAgentPanelSaveError: "Unable to save Agent settings.",
    canvasAgentPanelSendError: "Unable to send the message.",
    canvasAgentPanelToolRunning: "Running {tool}",
    canvasAgentPanelToolCompleted: "Completed",
    canvasAgentPanelToolFailed: "Failed",
    canvasAgentPanelToolDetails: "View execution details",
    canvasAgentPanelReviewTitle: "Result review",
    canvasAgentPanelReviewCurrent: "Current selection",
    canvasAgentPanelReviewAnalyzedTakes: "{count} versions analyzed",
    canvasAgentPanelReviewAffected: "Changes affect {count} downstream nodes",
    canvasAgentPanelImage: "Image attachment",
    canvasAgentPanelResize: "Resize Agent panel",
    canvasAgentPanelLoading: "Loading Agent conversation",
    canvasAgentPanelReferencePreview: "Preview referenced node {name}",
    canvasAgentPanelWaitingCanvasSave: "Wait for the canvas changes to finish saving before sending",
    canvasAgentPanelUndoAction: "Undo this canvas change",
    canvasAgentPanelUndoingAction: "Undoing…",
    canvasAgentPanelActionUndone: "Undone",
    canvasAgentPanelSkills: "Creative Skills",
    canvasAgentPanelSkillsBack: "Back to chat",
    canvasAgentPanelSkillsDescription: "Only project-scoped Skills can be enabled here. They guide this Canvas Agent's planning.",
    canvasAgentPanelSkillsShortDramaTitle: "Short drama",
    canvasAgentPanelSkillsShortDramaDescription: "Complete the requested story, script, storyboard, or canvas preparation and configure each node's model, parameters, and references.",
    canvasAgentPanelSkillsShortDramaInstall: "Install short-drama Skill",
    canvasAgentPanelSkillsInstalled: "Installed",
    canvasAgentPanelSkillsMarket: "Market",
    canvasAgentPanelSkillsLocal: "Import local",
    canvasAgentPanelSkillsEmpty: "No creative Skills are installed for this project.",
    canvasAgentPanelSkillsSearchPlaceholder: "Search Skills and press Enter",
    canvasAgentPanelSkillsInstall: "Install for this project",
    canvasAgentPanelSkillsLocalPlaceholder: "SKILL.md or a folder that contains it",
    canvasAgentPanelSkillsImport: "Import for this project",
    canvasAgentPanelSkillsRefresh: "Refresh list",
    canvasAgentPanelSkillsError: "Unable to update project Skills.",
    canvasAgentPanelSkillsReloadNeeded: "The Skill was saved. Wait for the Agent to finish, then refresh or reopen the chat.",
    enterPipeline: "Enter Pipeline Workbench",
    backToAgent: "Back to Agent Workspace",
    placeholder: "Pipeline Workbench coming soon",
    brandName: "Pipeline Studio",
    navProjects: "Projects",
    sidebarNavigation: "Pipeline Studio navigation",
    navLibrary: "Asset Library",
    ...
    createProjectHint: "Create a new canvas project",
    collapseSidebar: "Collapse sidebar",
    expandSidebar: "Expand sidebar",
    noMoreProjects: "No more projects",
    canvasLoading: "Loading canvas...",
    canvasInitialLoadFailed: "Canvas is temporarily unavailable.",
    canvasRetryLoad: "Retry loading canvas",
    canvasSaveIdle: "Waiting to save",
    canvasSaveSaving: "Saving...",
    canvasSaveSaved: "Saved",
    canvasSaveError: "Save failed",
    canvasBackProjects: "Back to all projects",
    canvasRenameProject: "Rename project",
    canvasRenameTitle: "Rename Project",
    ...
    canvasStoryScript: "Story Script",
    canvasCharacterViews: "Character Views",
    canvasReferenceVideo: "Reference Video",
    canvasAudioVideo: "Audio to Video",
    canvasAssetManagement: "Asset Management",
    canvasCloseAssetManagement: "Close asset management",
    canvasNodeCount: "{count} nodes",
    canvasElements: "Canvas elements",
    canvasProjectAssets: "Project assets",
    canvasAssetSearch: "Search by name",
    canvasAssetNotOnCanvas: "Not placed on canvas",
    canvasElementsEmpty: "No matching canvas elements",
    canvasAssetsEmpty: "No matching project assets",
    canvasAssetsLoading: "Loading project assets…",
    canvasFilterAll: "All",
    canvasFilterText: "Text",
    canvasFilterImage: "Images",
    canvasFilterVideo: "Video",
    canvasFilterAudio: "Audio",
    ...
    canvasWorkflowConfirmTitle: "Run the selected nodes?",
    canvasWorkflowConfirmDescription: "This follows node dependencies and calls the configured content-generation APIs, which may incur charges. Completed nodes are not run again in this workflow.",
    canvasWorkflowRunning: "Workflow running",
    canvasWorkflowCancelling: "Cancelling workflow",
    canvasWorkflowCompleted: "Workflow completed",
    canvasWorkflowFailed: "Workflow failed",
    canvasWorkflowFailureDetail: "{name}: {message}",
    canvasWorkflowCancelled: "Workflow cancelled",
    canvasWorkflowProgress: "{completed} / {total}",
    canvasWorkflowCurrentNode: "Running “{name}”",
    canvasWorkflowCancel: "Cancel workflow",
    canvasWorkflowCancelConfirm: "Waiting nodes will not start. Tasks already submitted to a provider may still incur charges.",
    canvasWorkflowRetry: "Retry from failure",
    canvasWorkflowWaitForActiveSteps: "Wait for active nodes to finish, or cancel the workflow first",
    canvasWorkflowRetryConfirm: "Retrying failed nodes calls the content-generation APIs again and may incur charges. Completed nodes are not run again.",
    canvasWorkflowStartFailed: "Failed to start workflow",
    canvasWorkflowCancelFailed: "Failed to cancel workflow",
    canvasWorkflowRetryFailed: "Failed to retry workflow",
    canvasWorkflowNodeLocked: "This node cannot be changed, disconnected, or deleted while its workflow is active. Cancel the workflow first.",
    canvasShowMinimap: "Show minimap",
    canvasHideMinimap: "Hide minimap",
    canvasZoomIn: "Zoom in",
    canvasZoomOut: "Zoom out",
    canvasZoomLevel: "Canvas zoom level",
    canvasAddNode: "Add node",
    canvasSelectTool: "Select tool (V)",
    canvasPanTool: "Pan canvas (H)",
    canvasCopySelection: "Copy selected nodes",
    canvasDuplicateSelection: "Duplicate selection (Ctrl/Cmd+D)",
    canvasTools: "Canvas tools",
    canvasUndo: "Undo",
    canvasRedo: "Redo",
    canvasShortcuts: "Keyboard shortcuts",
    canvasShortcutsDescription: "Keyboard and pointer controls available on the canvas",
    canvasShortcutsClose: "Close keyboard shortcuts",
    canvasShortcutsInputHint: "Global canvas shortcuts pause while you edit an input or text content.",
    canvasShortcutGroupEditing: "Editing",
    canvasShortcutGroupTools: "Tools & view",
    canvasShortcutGroupSelection: "Selection & navigation",
    canvasShortcutUndo: "Undo",
    canvasShortcutRedo: "Redo",
    canvasShortcutCopy: "Copy selected nodes",
    canvasShortcutPaste: "Paste nodes",
    canvasShortcutDuplicate: "Duplicate selection",
    canvasShortcutDelete: "Delete selection",
    canvasShortcutSelectTool: "Select tool",
    canvasShortcutPanTool: "Pan canvas tool",
    canvasShortcutFitCanvas: "Fit all nodes",
    canvasShortcutZoomIn: "Zoom in",
    canvasShortcutZoomOut: "Zoom out",
    canvasShortcutTemporaryPan: "Temporarily pan canvas",
    canvasShortcutMultiSelect: "Add or remove selection",
    canvasShortcutBoxSelect: "Box-select nodes",
    canvasShortcutClearSelection: "Clear selection",
    canvasShortcutModifier: "Ctrl/Cmd",
    canvasShortcutClick: "Click",
    canvasShortcutDrag: "Drag",
    canvasHelp: "Help",
    canvasPlaceholderBody: "This entry is reserved in the new Canvas information architecture. Its workflow will be connected in later node, workflow, and asset phases.",
    canvasAddMenu: "Add node",
    canvasTextNode: "Text node",
    canvasImageNode: "Image node",
    canvasVideoNode: "Video node",
    canvasAudioNode: "Audio node",
    canvasUploadMedia: "Upload media",
    canvasClipboardInvalid: "Canvas data in the clipboard could not be read",
    nodeText: "Text",
    nodeImage: "Image",
    nodeVideo: "Video",
    nodeAudio: "Audio",
    nodeCreateCopy: "Create copy",
    ...
    richTextHeading1: "Heading 1",
    richTextHeading2: "Heading 2",
    richTextHeading3: "Heading 3",
    richTextBulletList: "Bullet list",
    richTextOrderedList: "Numbered list",
    richTextUndo: "Undo edit",
    richTextRedo: "Redo edit",
    textAiTitle: "AI text assistant",
    promptReferencePicker: "Reference canvas elements or assets",
    promptReferenceEmpty: "No matching resources available",
    promptReferencesPreview: "Referenced media",
    promptReferenceUnavailable: "The referenced resource was removed or is unavailable",
    promptResourceRemoveAll: "Remove {label}, disconnect it, and delete all @ mentions",
    promptResourceRemoveConnection: "Remove {label} and disconnect its upstream connection",
    promptResourceRemoveMentions: "Remove all @ mentions of {label}",
    promptResourceRemoveBusy: "Wait for generation to finish or cancel it before removing resources",
    canvasUploadBlockedByConnection: "Disconnect upstream nodes before uploading or replacing local content",
    promptReferencePreview: "Preview {label}",
    promptReferenceRoleReference: "Reference",
    promptReferenceRoleFirstFrame: "First frame",
    promptReferenceRoleLastFrame: "Last frame",
    promptReferenceChangeRole: "Change connected resource role",
    promptReferenceUnsupported: "The current route does not support one of the referenced resources or roles",
    promptReferenceTooMany: "{label} accepts at most {count} resources",
    promptReferenceRequired: "The current route requires {label}",
    promptReferenceMinimumRequired: "The current route requires at least {count} asset(s) from: {labels}",
    promptReferenceTotalTooMany: "These asset types accept at most {count} item(s) in total: {labels}",
    promptResourceCanvas: "Canvas",
    promptResourceAsset: "Asset",
    textAiGeneratePlaceholder: "Describe the content to generate (Enter to generate, Shift+Enter for a new line)",
    textAiRevisePlaceholder: "Describe how to revise this text (Enter to generate, Shift+Enter for a new line)",
    textAiModel: "Text model",
    textAiModelLoading: "Loading models…",
    textAiNoModels: "No text model is available. Configure one in model settings first",
    textAiGenerate: "Generate content",
    textAiRevise: "Revise content",
    textAiGenerating: "AI is generating content…",
    textAiExpand: "Expand AI input",
    textAiCollapse: "Close expanded input",
    textAiPendingSave: "Wait for the node content to finish saving before using AI",
    textAiInstructionRequired: "Enter a generation or revision instruction first",
    textAiReferences: "Uses {count} upstream text nodes as reference",
    textAiError: "AI text generation failed",
    nodeTextInputHandle: "Connect upstream reference",
    nodeTextOutputHandle: "Connect to a downstream node",
    nodeAudioPlaceholder: "Drop an audio file",
    nodeAudioDropHint: "Or choose audio from your computer",
    nodeAudioChoose: "Choose audio",
    nodeAudioDropHere: "Drop to import this audio",
    nodeAudioUploading: "Importing audio…",
    nodeAudioOnlyError: "Audio nodes only accept audio files",
    nodeAudioTooLarge: "Audio files must not exceed 10 MiB",
    nodeAudioDownload: "Download audio",
    nodeAudioRetry: "Reload",
    nodeAudioUnavailable: "The audio could not be loaded. Check the file",
    nodeAudioWaveform: "Audio waveform",
    nodeAudioWaveformLoading: "Analyzing audio waveform",
    nodeAudioWaveformUnavailable: "The waveform could not be analyzed. Playback is still available",
    nodeAudioInputHandle: "Connect an upstream video to extract audio",
    nodeAudioOutputHandle: "Connect the current audio downstream",
    audioAiTitle: "AI audio separation",
    audioAiDescription: "Connect one video node, then extract either clean vocals or background audio.",
    audioAiRoute: "Audio processing model",
    audioAiRoutesLoading: "Loading audio models…",
    audioAiNoRoutes: "No audio processing model is available",
    audioAiVideoRequired: "Connect an available video node first",
    audioAiPendingSave: "Wait for the audio node to finish saving before processing",
    audioAiGenerate: "Extract audio",
    audioAiGenerating: "Extracting audio…",
    audioAiCancel: "Cancel audio extraction",
    audioMetadataSummary: "{duration} · {format}",
    audioMetadataChannels: "{count} channels",
    audioMetadataSampleRate: "{rate} kHz",
    nodeMediaPlaceholder: "Drop media or wait for generator support",
    nodeImageCreatingCopy: "Creating image copy...",
    ...
    nodeVideoUnavailable: "The video could not be loaded. Check the file or add a Take from history as a new node",
    nodeImageEdit: "Edit image",
    nodeImageEditPreview: "Image edit preview",
    nodeImageRotateLeft: "Rotate 90° left",
    nodeImageRotateRight: "Rotate 90° right",
    nodeImageFlipHorizontal: "Flip horizontally",
    nodeImageFlipVertical: "Flip vertically",
    nodeImageEditReset: "Reset",
    nodeImageEditSave: "Save as new node",
    nodeImageEditSaveDisabled: "Rotate or flip the image before saving",
    nodeImageEditSaving: "Saving edited image…",
    nodeImageEditSaved: "Edited image saved as a new node",
    nodeImageEditSaveError: "Failed to save the edited image",
    nodeImageEditCancel: "Cancel editing",
    nodeImageEditHint: "Preview only. The original image will not be changed",
    nodeImageEditChangedHint: "Preview adjusted. Cancelling will leave the original unchanged",
    nodeImageDownload: "Download image",
    nodeImageLoadFailed: "Unable to load the local image",
    nodeImageRetry: "Reload",
    imageAiTitle: "AI image generation",
    imageAiModifyTitle: "AI image modification",
    imageAiPlaceholder: "Describe the image to create (Enter to generate, Shift+Enter for a new line)",
    imageAiModifyPlaceholder: "Describe how to modify the current image (Enter to generate, Shift+Enter for a new line)",
    imageAiCurrentReference: "Current image used as reference",
    imageAiInstruction: "Image generation description",
    imageAiRoute: "Image generation model",
    imageAiAspectRatio: "Aspect ratio",
    imageAiResolution: "Resolution",
    imageAiRoutesLoading: "Loading image models…",
    imageAiNoRoutes: "No image generation model is available. Enable content generation, configure credentials, and enable a text-to-image route first",
    imageAiNoModifyRoutes: "No image modification model is available. Enable content generation, configure credentials, and enable an image-to-image route first",
    imageAiNoRoutesShort: "No available model",
    imageAiPendingSave: "Wait for the image node to finish saving before generating",
    imageAiInstructionRequired: "Describe the image to generate first",
    imageAiPromptTooShort: "The image description must contain at least {count} characters",
    imageAiPromptTooLong: "The image description cannot exceed {count} characters",
    imageAiGenerating: "Generating image…",
    imageAiCancel: "Cancel generation",
    imageAiError: "AI image generation failed",
    imageAiCancelError: "Failed to cancel image generation",
    imageAiGenerate: "Generate image",
    imageAiModify: "AI modify",
    nodeVideoOnlyError: "Video nodes only accept video files",
    nodeVideoUploading: "Importing video…",
    nodeVideoDropHere: "Drop to import this video",
    nodeVideoDownload: "Download video",
    nodeVideoInputHandle: "Connect upstream video references",
    nodeVideoOutputHandle: "Connect the current video downstream",
    videoAiTitle: "AI video generation",
    videoAiPlaceholder: "Describe the video, then type @ to add frames or reference media",
    videoAiInstruction: "Video generation description",
    videoAiReferenceHint: "Choose a role, then type @ to attach media",
    videoAiRoute: "Video generation model",
    generationModelDetails: "View model information",
    videoAiModeText: "Text to video",
    videoAiModeImage: "Image to video",
    videoAiModeMultimodal: "Multimodal",
    videoAiModeLipSync: "Audio lip sync",
    lipSyncTitle: "Kling lip sync",
    lipSyncVideo: "Person video",
    lipSyncAudio: "Dubbing audio",
    lipSyncVideoMissing: "Connect one person video node",
    lipSyncAudioMissing: "Connect one dubbing audio node",
    lipSyncVideoCountRequired: "Kling lip sync requires exactly one person video",
    lipSyncAudioCountRequired: "Kling lip sync requires exactly one dubbing audio",
    lipSyncTargetFace: "Target person",
    lipSyncFacePending: "Generate to detect people in the video automatically",
    lipSyncAnalyzing: "Detecting people in the video…",
    lipSyncAnalysisFailed: "Person detection failed. Try again",
    lipSyncFaceRequired: "Choose the person to lip-sync",
    lipSyncPerson: "Person {index}",
    lipSyncRecommended: "Recommended",
    lipSyncAutomaticTiming: "Match timing automatically",
    lipSyncTiming: "Timing and volume",
    lipSyncAudioStart: "Audio trim start",
    lipSyncAudioEnd: "Audio trim end",
    lipSyncInsertTime: "Video insert time",
    lipSyncSoundVolume: "Dubbing volume",
    lipSyncOriginalVolume: "Original video volume",
    lipSyncDurationTooShort: "The trimmed audio must be at least 2 seconds",
    lipSyncOverlapRequired: "Audio must overlap the person's available interval by at least 2 seconds",
    lipSyncGenerateSelected: "Generate for selected person",
    lipSyncAnalysisTimeout: "Person detection timed out. Try again",
    videoAiImageRole: "Role for the next image",
    videoAiRoleReference: "Reference media",
    videoAiRoleFirstFrame: "First frame",
    videoAiRoleLastFrame: "Last frame",
    videoAiParameters: "Parameters",
    generationEnabled: "On",
    generationDisabled: "Off",
    generationAudioOn: "Audio on",
    generationAudioOff: "Audio off",
    generationDurationAuto: "Auto duration",
    generationOptionalRandom: "Leave empty for random",
    generationAdaptive: "Adaptive",
    generationTextModelDescription: "Text model provided by {provider}",
    generationVisionInput: "Image input",
    generationReasoning: "Reasoning",
    generationContextWindow: "{count} context",
    generationParametersMutuallyExclusive: "Choose only one: {fields}",
    videoAiRoutesLoading: "Loading video models…",
    videoAiNoRoutes: "No video generation model is available. Enable content generation and configure credentials first",
    videoAiPendingSave: "Wait for the video node to finish saving before generating",
    videoAiInstructionRequired: "Describe the video to generate first",
    videoAiPromptTooShort: "The video description must contain at least {count} characters",
    videoAiPromptTooLong: "The video description cannot exceed {count} characters",
    videoAiGenerating: "Generating video…",
    videoAiCancel: "Cancel generation",
    videoAiError: "AI video generation failed",
    videoAiCancelError: "Failed to cancel video generation",
    videoAiGenerate: "Generate video",
    videoHistoryTitle: "Generation history",
    videoHistoryCurrent: "Current Take",
    videoHistoryUseTake: "Add as new node",
    videoHistoryRetry: "Retry this generation",
    videoHistoryRedownload: "Download existing result again",
    videoHistoryResubmit: "Resubmit (may incur charges)",
    generationFailureProviderInputDownload: "The provider could not fetch an input reference and returned no downloadable output.",
    generationFailureOutputDownload: "The provider completed generation, but the result was not saved locally. It can be downloaded again.",
    videoHistoryWorking: "Working…",
    videoHistoryEmpty: "No video generations yet",
    videoHistoryNoPrompt: "No prompt",
    videoHistoryUploadSource: "Local upload",
    videoHistoryUploadSourceDescription: "The original video remains available as an independent new node",
    videoHistorySucceeded: "Succeeded",
    videoHistoryFailed: "Failed",
    videoHistoryCancelled: "Cancelled",
    videoHistoryRunning: "Running",
    videoHistoryOpen: "Generation history",
    generationOutputStale: "A directly referenced text node changed; this result is now outdated",
    generationOutputStaleBadge: "Outdated",
    videoMetadata: "{duration} · {resolution}",
    nodeNameAria: "{type} node name",
    emptyTitle: "No projects yet",
    emptyDescription: "Create a project and start creating on the infinite canvas",
    emptyNewProject: "New Project",
    viewGrid: "Grid view",
    viewList: "List view",
    statusDraft: "Draft",
    statusAnalyzing: "Analyzing",
    statusAssetsReady: "Assets ready",
    statusStoryboardReady: "Storyboard ready",
    ...
    videos: "videos",
    updatedAt: "Updated",
    confirmDelete: "Remove project \"{title}\" from the home page? Its folder and data will not be deleted.",
    dialogTitle: "New Project",
    dialogProjectTitle: "Project title",
    dialogProjectTitlePlaceholder: "Enter project name",
    dialogProjectLocation: "Project location",
    dialogProjectLocationPlaceholder: "Enter an absolute parent folder path",
    dialogProjectLocationHint: "A dedicated folder named after the project will contain its data and assets.",
    dialogProjectPathPreview: "Project folder",
    openExistingProject: "Open Existing Project",
    existingProjectLocation: "Existing project folder",
    existingProjectLocationPlaceholder: "Enter the absolute path of a folder containing .pipeline-studio",
    existingProjectLocationHint: "Select or enter a Pipeline Studio project root folder.",
    dialogOpen: "Open Project",
    dialogScript: "Script text",
    dialogScriptPlaceholder: "Paste or type script text...",
    dialogWorkspace: "Workspace",
    dialogWorkspacePlaceholder: "Select workspace directory",
    dialogBrowse: "Browse",
    dialogCancel: "Cancel",
    dialogCreate: "Create Project",
    dialogStylePreset: "Style preset",
    dialogStyleRealistic: "Realistic",
    dialogStyleAnime: "Anime",
    dialogStyleWatercolor: "Watercolor",
    dialogStyleCyberpunk: "Cyberpunk",
  },
} as const;
