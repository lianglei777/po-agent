export const en = {
  ...
  contentGeneration: {
    ...
    newSessionTitle: "Create a new session",
    newSessionDescription:
      "Choose one mode for this session. The mode cannot be changed after creation.",
    chatMode: "Model conversation",
    chatModeDescription: "Use a configured language model and agent tools.",
    mode: "Content generation",
    modeDescription: "Use one configured API to generate images or videos.",
    noConfiguredApis: "No content generation APIs configured",
    createSession: "Create generation session",
