export const en = {
  ...
  pipeline: {
    ...
    imageAiPlaceholder: "Describe the image you want to create. Models, ratios, and references will be connected in the next phase.",
    imageAiInstruction: "Image generation description",
    imageAiComingSoon: "Image generation settings arrive in the next phase",
    imageAiDisabledReason: "Image Node B will connect model selection and real image generation",
