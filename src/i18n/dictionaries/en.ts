export const en = {
  ...
  pipeline: {
    ...
    generationConfigHint: "Only capabilities supported by this model are shown. Compatible settings are preserved when switching models.",
    generationMoreSettings: "More settings",
