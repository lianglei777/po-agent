export const en = {
  ...
  pipeline: {
    ...
    canvasAgentPanelSkillsShortDramaTitle: "Example Skill: Short drama",
    canvasAgentPanelSkillsShortDramaDescription: "Start with the story, script, or storyboard. It plans the canvas or generates only when you ask.",
    canvasAgentPanelSkillsShortDramaInstall: "Install example Skill",
