export const en = {
  ...
  pipeline: {
    ...
    nodeAudioDropReplace: "Drop to replace the current audio",
    ...
    nodeAudioReplace: "Replace audio",
    nodeAudioDownload: "Download audio",
    nodeAudioRetry: "Reload",
    nodeAudioUnavailable: "The audio could not be loaded. Check the file or replace it",
    ...
    nodeImageChoose: "Choose local image",
    nodeImageDropHint: "You can also drop an image here",
    nodeImageDropHere: "Drop to import this image",
    nodeImageDropReplace: "Drop to replace the current image",
    nodeImageUploading: "Importing image...",
    nodeImageCreatingCopy: "Creating image copy...",
    nodeImageOnlyError: "Image nodes only accept image files",
    ...
    nodeVideoUnavailable: "The video could not be loaded. Check the file or choose another Take from history",
    ...
    nodeImageReplace: "Replace image",
    ...
    nodeVideoDropReplace: "Drop to replace the current video",
    nodeVideoReplace: "Replace video",
    ...
    videoHistoryUseTake: "Use this Take",
    ...
    videoHistoryUploadSourceDescription: "The original video remains available as a selectable output",
    ...
    generationOutputStale: "Generation inputs changed; this result is now outdated",
