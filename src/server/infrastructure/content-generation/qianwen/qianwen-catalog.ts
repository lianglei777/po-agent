...
interface QianwenImageExecutionConfig{protocol:"dashscope-media-v1";operation:typeof QIANWEN_Z_IMAGE_TEXT_TO_IMAGE_OPERATION|typeof QIANWEN_WAN_2_6_TEXT_TO_IMAGE_OPERATION;endpointId:"multimodal-generation"|"image-generation";vendorModel:"z-image-turbo"|"wan2.6-t2i";requestProfile:"messages-text-image-v1";resultProfile:"choices-content-image-v1";assetBindings:[];pollIntervalMs?:5_000;submitMode:"sync"|"async-task"}
